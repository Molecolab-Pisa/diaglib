program reference
    ...
    integer, parameter :: n = 500, n_targ = 5, luref = 101
    ...
    call dump_eigpairs(luref, n, n_targ, eig, a, "Symmetric diagonaliztion")

    a = copy
    !symmetric generalized problem
    call dsygv(1, "V", "U", n, a, n, b, n, eig, work, lwork, info)
    call check_lapack(info)
    call dump_eigpairs(luref, n, n_targ, eig, a, "Symmetric Generalized diagonaliztion")
    ...
    call check_lapack(info)
    !call is_sorted(eig)
    call dump_eigpairs(luref, n, n_targ, eig, evec, "Non Symmetric diagonaliztion, Left")
    call dump_eigpairs(luref, n, n_targ, eig, evec(1, 1, 2), "Non Symmetric diagonaliztion, Right")
    ...
    call check_lapack(info)
    eig = -one/eig
    call dump_eigpairs(luref, 2*n, n_targ, eig, evec, "Linerar response diagonalization")
